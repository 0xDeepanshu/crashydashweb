          ...
          <div className="xpc-float">
            ...
            <div className="rounded-2xl border border-white/8 overflow-hidden"
              ...
              <div className="flex items-center gap-3 px-5 pt-5 pb-3">
                {/* Avatar */}
                <div className="w-11 h-11 rounded-full bg-gradient-to-br from-primary to-secondary flex-shrink-0 flex items-center justify-center">
                  <span className="text-white text-sm font-bold">CD</span>
                </div>
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-1.5">
                    <span className="text-sm font-bold text-foreground truncate">Crashy Dash</span>
